...
class PlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'max_images_per_ad' => 'required|integer|min:1|max:8',
            ...
            'max_images_per_ad.required' => 'Le nombre maximum d\'images par annonce est obligatoire.',
            'max_images_per_ad.max' => 'Le nombre maximum d\'images ne peut pas dépasser 8.',
        ...
        Plan::create([
            ...
            'features' => [
                ...
                'max_images_per_ad' => (int) $validated['max_images_per_ad'],
