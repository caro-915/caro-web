...
<div class="py-12">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <div class="mb-8">
            <a href="{{ route('admin.plans.index') }}" class="text-pink-600 hover:text-pink-700 font-semibold">← Retour aux plans</a>
            <h1 class="text-3xl font-bold text-gray-900 mt-4">Modifier le plan</h1>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.plans.update', $plan->id) }}" method="POST" class="bg-white rounded-lg shadow p-8">
            @csrf
            @method('PUT')
            ...
            <fieldset class="mb-8 border border-gray-200 rounded-lg p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="max_active_ads" name="max_active_ads" value="{{ old('max_active_ads', $plan->features['max_active_ads']) }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent" 
                        min="1" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="boosts_per_month" name="boosts_per_month" value="{{ old('boosts_per_month', $plan->features['boosts_per_month']) }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent" 
                        min="0" required>
                ...
                <div>
                    ...
                    <input type="number" id="boost_duration_days" name="boost_duration_days" value="{{ old('boost_duration_days', $plan->features['boost_duration_days']) }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent" 
                        min="1" required>
            ...
            <div class="mb-8">
                <label class="flex items-center">
                    <input type="checkbox" id="is_active" name="is_active" {{ old('is_active', $plan->is_active) ? 'checked' : '' }} 
                        class="rounded border-gray-300">
                    <span class="ml-2 text-sm font-semibold text-gray-900">Activer ce plan</span>
                </label>
                <p class="text-gray-600 text-sm mt-1">Les utilisateurs ne verront que les plans actifs</p>
            </div>
